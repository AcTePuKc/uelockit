...
if ([string]::IsNullOrWhiteSpace($SourceLocresPath)) {
    ...
    if (-not [string]::IsNullOrWhiteSpace($configValue)) {
        $SourceLocresPath = $ExecutionContext.SessionState.Path.GetUnresolvedProviderPathFromPSPath($configValue)
    }
    else {
...
if ([string]::IsNullOrWhiteSpace($TranslationCsvPath)) {
    ...
    if (-not [string]::IsNullOrWhiteSpace($configValue)) {
        $TranslationCsvPath = $ExecutionContext.SessionState.Path.GetUnresolvedProviderPathFromPSPath($configValue)
    }
    else {
...
if ([string]::IsNullOrWhiteSpace($TranslationJsonPath)) {
    ...
    if (-not [string]::IsNullOrWhiteSpace($configValue)) {
        $TranslationJsonPath = $ExecutionContext.SessionState.Path.GetUnresolvedProviderPathFromPSPath($configValue)
    }
    else {
...
if ([string]::IsNullOrWhiteSpace($OutputLocresPath)) {
    ...
    if (-not [string]::IsNullOrWhiteSpace($configValue)) {
        $OutputLocresPath = $ExecutionContext.SessionState.Path.GetUnresolvedProviderPathFromPSPath($configValue)
    }
    else {
